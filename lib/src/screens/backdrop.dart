...
const double _kFlingVelocity = 2.0; // velocity constant
  ...
  Widget build(BuildContext context) {
    var appBar = AppBar(
      ...
      actions: <Widget>[
        IconButton(
          icon:
              Icon(Icons.search, semanticLabel: 'search', color: Colors.black),
          onPressed: () {
            print('Search');
          },
        ),
        IconButton(
          icon: Icon(Icons.tune, semanticLabel: 'filter', color: Colors.black),
          onPressed: () {
            print('filter');
          },
        ),
